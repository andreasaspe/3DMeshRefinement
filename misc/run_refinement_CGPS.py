"""
Reference-only mesh-refinement script for the private CGPS
...
output_folder_root = f"/data/awias/periseg/DTU-Pericardium-04-02-2026/TS_pericardium/pytorch3d_new"
data_folder = f"/data/awias/periseg/DTU-Pericardium-04-02-2026/NIFTI_collected_new"

csv_path = "/data/awias/periseg/DTU-Pericardium-04-02-2026/series_train_test.csv"

# Vector fields folder
vf_folder = f"/data/awias/periseg/DTU-Pericardium-04-02-2026/TS_pericardium/vector_fields_withLAA_new"
...
for series in tqdm(all_series):
    ...
    for i in loop:
        ...
        if i < phase1_iters:
            ...
            w_vf_inside  = w_vf_inside_p1  + (w_vf_inside_p2  - w_vf_inside_p1)  * blend
            w_vf_outside = w_vf_outside_p1 + (w_vf_outside_p2 - w_vf_outside_p1) * blend
